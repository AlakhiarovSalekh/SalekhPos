...
public sealed record SyncMessageResponse(Guid MessageId, Guid DeviceId, long Sequence, int ProtocolVersion,
    string MessageType, string Status, string PayloadDigest, DateTimeOffset AcceptedAt);
