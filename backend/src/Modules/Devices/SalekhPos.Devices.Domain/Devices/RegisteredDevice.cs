...
{
    public RegisteredDevice(Guid id, Guid registerId, string code, string name, string platform, int syncProtocolVersion, string publicKey)
    {
        ...
        if (string.IsNullOrWhiteSpace(publicKey) || publicKey.Length > 2048) throw new ArgumentException("Device public key is invalid.");
