...
public sealed record RecordCashMovementRequest(Guid RegisterId, string Kind, decimal Amount, string Reason);
...
public sealed record CloseShiftRequest(Guid RegisterId, decimal CountedCash);
