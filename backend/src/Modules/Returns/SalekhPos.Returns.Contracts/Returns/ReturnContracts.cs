...
public sealed record ReturnSummaryResponse(Guid Id, Guid SaleId, Guid BranchId, string Currency, decimal Amount,
    string Reason, DateTimeOffset CompletedAt);
public sealed record ReturnPage(IReadOnlyList<ReturnSummaryResponse> Items, Guid? NextCursor);
